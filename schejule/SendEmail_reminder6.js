...
export const sendReminder6 = async () => {
    try {
        ...
        for (const suratizin of suratizinList) {
            ...
            if (suratizin.status_reminder6 !== 'berhasil6') {
                const mailOptions = {
                ...
                transporter.sendMail(mailOptions, async (error, info) => {
                    if (error) {
                        ...
                        if (info.accepted.includes(suratizin.from_email)) {
                            try {
                                await suratizin.update({ status_reminder6: 'berhasil6' });
                                console.log('Status updated to "berhasil6" for:', suratizin.uuid);
                            } catch (updateError) {
                                console.error('Error updating status_reminder6:', updateError);
                            }
                        }
                    }
                });
